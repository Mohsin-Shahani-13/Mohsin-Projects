...
{
    public class MetaRMAOrdersWithErrors
    {
        cDAL oDAL;
        ...
        public List<Hashtable> lstRMAOrdersWithErrors { get; set; }
...
";
            ...
            cLog oLog = new cLog();
            oLog.AddSqlQuery("172", query, string.Empty, false);
            ...
            {
                if (dt.Rows.Count > 0)
                    lstRMAOrdersWithErrors = cCommon.ConvertDtToHashTable(dt);
                return true;
